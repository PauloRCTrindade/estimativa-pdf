...
async function handleDataMasses(req, res, slug) {
  ...
  if (!id) {
    if (req.method === 'GET') {
      ...
      if (error) return res.status(400).json({ error: error.message });
      return res.status(200).json((rows || []).map(normalizeDataMassRow));
    }
    ...
    if (req.method === 'POST') {
      ...
      if (error) return res.status(400).json({ error: error.message });
      return res.status(201).json(normalizeDataMassRow(data));
    }
  ...
  if (req.method === 'GET') {
    ...
    if (error) return res.status(400).json({ error: error.message });
    if (!data) return res.status(404).json({ error: 'Not found' });
    return res.status(200).json(normalizeDataMassRow(data));
  }
...
async function handleDataMassColumns(req, res, slug) {
  ...
  if (!id) {
    if (req.method === 'GET') {
      ...
      if (error) return res.status(400).json({ error: error.message });
      return res.status(200).json((data || []).map(toCamelDataMassColumn));
    }
    ...
    if (req.method === 'POST') {
      ...
      if (error) return res.status(400).json({ error: error.message });
      return res.status(201).json(toCamelDataMassColumn(data));
    }
  ...
  if (req.method === 'GET') {
    ...
    if (error) return res.status(400).json({ error: error.message });
    if (!data) return res.status(404).json({ error: 'Not found' });
    return res.status(200).json(toCamelDataMassColumn(data));
  }
...
async function handleDataMassTags(req, res, slug) {
  ...
  if (!id) {
    if (req.method === 'GET') {
      ...
      if (error) return res.status(400).json({ error: error.message });
      return res.status(200).json((data || []).map(toCamelDataMassTag));
    }
    ...
    if (req.method === 'POST') {
      ...
      if (error) return res.status(400).json({ error: error.message });
      return res.status(201).json(toCamelDataMassTag(data));
    }
  ...
  if (req.method === 'GET') {
    ...
    if (error) return res.status(400).json({ error: error.message });
    if (!data) return res.status(404).json({ error: 'Not found' });
    return res.status(200).json(toCamelDataMassTag(data));
  }
...
export default async function handler(req, res) {
  ...
  switch (resource) {
    ...
    default:
      return res.status(404).json({ error: 'Not found', debug: { slug, resource, rest, query: req.query, url: req.url } });
  }
}
